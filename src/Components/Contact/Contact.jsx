      ...
      <div className="flex flex-wrap -mx-4 lg:justify-between">
        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div className="mb-12 max-w-[570px] lg:mb-0">
            <h2 className="text-dark text-blue-600 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
              GET IN TOUCH WITH US
            </h2>
            <p className="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
            Reach out to us during working hours at our hotline: 1-559-632-1273. Our team is available to assist you with any energy-related questions or concerns. Were here to help!
            </p>
